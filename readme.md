...
<h3 align="center">NOTE: To keep icons consistent and to ensure widespread browser support, we don't accept pull requests for icon submissions. If you would like an icon added, please open an issue.<h3>
